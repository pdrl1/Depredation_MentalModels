...
# Australia (AU) · Gulf Coast (AL)
# ============================================================
#
# Produces 7 publication-ready plots, each a 1-row × 2-column
...
# The two panels are then assembled 1 × 2.
...
p5_al <- make_subregion_panel("Gulf Coast")
...
save_plot(p6, "P6_indegree_vs_outdegree.pdf", width = 14, height = 7)
...
cat("  P5_subregion_top5.pdf          — Top 5 per sub-region (2 stacked panels)\n")

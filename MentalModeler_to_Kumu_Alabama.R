...
category_lookup <- tribble(
  ...
  "Erratic Fish Behavior On Hook",                                    "Ecological & Biological Factors",
  ...
  "Fishing Effort Throughout Season",                                 "Fisheries Operations & Practices",
  ...
  # ── Human Dimensions ────────────────────────────────────────────────────────
  "Angler Competency",                                                "Human Dimensions",
  "Angler Satisfaction",                                              "Human Dimensions",
  ...
  "Shark Regulatory Protection",                                      "Policy & Economics",
